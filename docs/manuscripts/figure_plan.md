...
into an auditable 3D tissue object: Cell-GPS Search-and-Find/StructureMap
...
- **A. StructureMap-guided semantic contour generation.** Show the ordered
  Xenium slice stack, the Cell-GPS/Search-and-Find relationship layer used to
...
- StructureMap panels should describe Cell-GPS as the relationship-mapping layer;
